  ...
  <div class="nav_container">
    ...
    <div class="navbar">
      <div>
        ...
        >
          <defs>
            <path id="a" d="M18.834.144H.06v48.337h37.549V.144z"></path>
            <path id="c" d="M0 13h158V0H0z"></path>
            <path id="e" d="M.294.03h8.677v10.944H.294z"></path>
            <path id="g" d="M0 10.975h123.946V.03H0z"></path>
          </defs>
          <g fill="none" fill-rule="evenodd">
            ...
            <g>
              ...
              <path
                fill="#1D1D1B"
                fill-rule="nonzero"
                d="M206.719 66.977h-3.406v8.836h-2.127v-8.836h-3.422V65.19h8.955z"
              ></path>
      ...
      <div>
        <div class="input-box">
          <svg class="search_spyglass " width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div>
        <div class="dropdown" >
          ...
          <button class="dropbtn"><svg class="responsiveAccountHeader_accountIcon" width="24px" height="24px" viewBox="0 0 24 24">
        ...
        <div class="dropdown" >
          ...
          <button class="dropbtn"><svg class="responsiveFlyoutBasket_icon responsiveFlyoutBasket_icon-basket" width="24" height="24" viewBox="0 0 24 24">
          ...
          <div class="dropdown-content" style="right:0">
            ...
            <div class="cart__nav--items">
              <span>Items in your cart</span>
              <h2 id = "nav_cart_price">$100.00</h2>
    ...
    <div class="navbar-list"> 
      ...
      <div class="dropdown" >
        ...
        <div class="dropdown-content">
          <div>
            <h4>By Specific Concern</h4>   
            <a href="./shop2.html">Acne & Blemishes</a>
            <a href="./product.html">Fine Lines & Wrinkles</a>
            <a href="./product.html">Caffeine</a>
            <a href="./product.html">Dark Circles</a>
            <a href="./product.html">Dry Skin</a>
      ...
      <div>
        ...
        <a href="./shop3.html">View All Skin Care</a>
        ...
        <div>
          ...
          <div>
            ...
            <div>
              <h4>By Specific Concern</h4>   
              <a href="./shop3.html">Acne & Blemishes</a>
              <a href="./product.html">Fine Lines & Wrinkles</a>
              <a href="./product.html">Caffeine</a>
              <a href="./product.html">Dark Circles</a>
              <a href="./product.html">Dry Skin</a>
      ...
      <div class="dropdown" >
        ...
        <div class="dropdown-content">
          <div>
            <h4>Popular Categories</h4>   
            <a href="./shop4.html">View All Skin Care</a>
            <a href="./product.html">New In</a>
            <a href="./product.html">Clean Skincare</a>
            <a href="./product.html">5* Rated Product</a>
            <a href="./product.html">Gifts & Sets</a>
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  <h4>By Specific Concern</h4>   
                  <a href="./shop4.html">Acne & Blemishes</a>
                  <a href="./product.html">Fine Lines & Wrinkles</a>
                  <a href="./product.html">Caffeine</a>
                  <a href="./product.html">Dark Circles</a>
                  <a href="./product.html">Dry Skin</a>
        ...
        <div class="dropdown-content">
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  <h4>By Specific Concern</h4>   
                  <a href="./shop5.html">Acne & Blemishes</a>
                  <a href="./product.html">Fine Lines & Wrinkles</a>
                  <a href="./product.html">Caffeine</a>
                  <a href="./product.html">Dark Circles</a>
                  <a href="./product.html">Dry Skin</a>
      ...
      <div class="dropdown" >
        ...
        <div class="dropdown-content">
          <div>
            <h4>Popular Categories</h4>   
            <a href="./shop2.html">View All Skin Care</a>
            <a href="./product.html">New In</a>
            <a href="./product.html">Clean Skincare</a>
            <a href="./product.html">5* Rated Product</a>
            <a href="./product.html">Gifts & Sets</a>
      ...
      <div class="dropdown" >
        ...
        <div class="dropdown-content">
          <div>
            <h4>Popular Categories</h4>   
            <a href="./shop5.html">View All Skin Care</a>
            <a href="./product.html">New In</a>
            <a href="./product.html">Clean Skincare</a>
            <a href="./product.html">5* Rated Product</a>
            <a href="./product.html">Gifts & Sets</a>
    ...
    <div class="navbar-services">
      ...
      <div>
        <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg">
          <g fill-rule="nonzero" fill="none">
            <path class="tickbat_icon_svg-stroke" d="M27 12H13v17h14V12z" stroke-width="2"></path>
            <path class="tickbat_icon_svg-stroke" stroke-width="2" d="M16 20l3.031 3.035L23.983 17"></path>
            <path fill  = "333333" class="tickbat_icon_svg-fill" d="M16 10a2 2 0 0 1 2-2v2h-2zM16 11h8v2h-8zM24 10a2 2 0 0 0-2-2v2h2zM18 8h4v2h-4z"></path>
            <path class="tickbat_icon_svg-fill" d="M22 10h2v2h-2zM16 10h2v2h-2z"></path>
          </g>
        </svg>
      ...
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="-8 -8 40 40">
          <path fill  = "#333333" class="responsiveUsp_icon_svg-fill" d="M8.58123535,17.3666782 L8.57536766,17.3724713 L4,12.8552083 L5.38991989,11.4829397 L9.21683579,15.2612558 L19.6100801,5 L21,6.37226867 L9.22270348,18 L8.58123535,17.3666782 Z"></path>
        </svg>
    ...
    <div class="navbar-banner-container">
      <div class="navbar-banner">
        <a href = "./AboutUs.html">Up to 30% off with code COUNTDOWN + 11-Piece Beauty Bag (worth $87) @ $150 | SHOP NOW ></a>
      </div>
    </div>
  </div>
